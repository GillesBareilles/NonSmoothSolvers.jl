...
function esearch!(bundle::Bundle{Tf},
    ...
    while gxtdxc <  wolfetest
        ...
        if gxtdxc < wolfetest
            # gxoldxc = gxcdxc
            gxcdxc = gxtdxc
            overwriteinplace(xc, fxc, gxc, erxc, xtrap, fxtrap, gxtrap, erxtrap)
            printstyled("xxxxx\n")
        end
    ...
    if esearch==1
        nxhi=nxhi+1
        if fxtrap ≤ fxc
            overwriteinplace(xhi, fxhi, gxhi, erxhi, xc, fxc, gxc, erxc)
            overwriteinplace(xlo, fxlo, gxlo, erxlo, xtrap, fxtrap, gxtrap, erxtrap)

            dxlo=-dt*gxtdxc;
            dxhi=-dt*gxcdxc;
        else
            overwriteinplace(xhi, fxhi, gxhi, erxhi, xtrap, fxtrap, gxtrap, erxtrap)
            overwriteinplace(xlo, fxlo, gxlo, erxlo, xc, fxc, gxc, erxc)
        ...
        if fxc ≤ fp
            overwriteinplace(xhi, fxhi, gxhi, erxhi, p, fp, gp, Tf(0))
            overwriteinplace(xlo, fxlo, gxlo, erxlo, xc, fxc, gxc, erxc)
            ...
            overwriteinplace(xhi, fxhi, gxhi, erxhi, xc, fxc, gxc, erxc)
            overwriteinplace(xlo, fxlo, gxlo, erxlo, p, fp, gp, Tf(0))
